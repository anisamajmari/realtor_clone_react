      ...
      {landlord !== null && (
        <div className="flex flex-col w-full">
          ...
          <div className="mt-3 mb-6">
            <textarea
              className="w-full px-4 py2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-500"
              name="message"
              id="message"
              rows="2"
              value={message}
